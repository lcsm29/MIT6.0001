...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        shift_dict = {c: a[(i + shift) % 26] if i < 26
    ...
    def apply_shift(self, shift):
        ...
        shifted = [d[c] if c in d.keys() else c for c in self.message_text]
        return ''.join(shifted)
...
if __name__ == '__main__':
    ...
    print(
        'Expected Output: '
        'Behuc yfikc tebeh iyj qcuj, sediusjujkh qtyfyisydw ubyj, iut te '
        'uykicet jucfeh ydsytytkdj kj bqrehu uj tebehu cqwdq qbygkq.'
    )
    print(f'Actual Output: {plaintext.get_message_text_encrypted()}')
    ...
    ciphertext = CiphertextMessage(
        'Behuc yfikc tebeh iyj qcuj, sediusjujkh qtyfyisydw ubyj, iut te '
        'uykicet jucfeh ydsytytkdj kj bqrehu uj tebehu cqwdq qbygkq. '
        'Kj udyc qt cydyc ludyqc, gkyi deijhkt unuhsyjqjyed kbbqcse bqrehyi '
        'dyiy kj qbygkyf un uq seccete sediugkqj. Tkyi qkju yhkhu tebeh yd '
        'hufhuxudtuhyj yd lebkfjqju lubyj uiiu sybbkc tebehu uk vkwyqj dkbbq '
        'fqhyqjkh. Unsufjukh iydj essqusqj skfytqjqj ded fheytudj, ikdj yd '
        'skbfq gky evvysyq tuiuhkdj cebbyj qdyc yt uij bqrehkc.')
    print(
        'Expected Output:',
        (10,
         'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do '
    ...
    plaintext = PlaintextMessage('heLLo !wO@.rLd!', 5)
    print('Expected Output: mjQQt !bT@.wQi!')
    print(f'Actual Output: {plaintext.get_message_text_encrypted()}')

    # Example test case (CiphertextMessage)
    ciphertext = CiphertextMessage('mjQQt !bT@.wQi!')
    print('Expected Output:', (21, 'heLLo !wO@.rLd!'))
    print(f'Actual Output: {ciphertext.decrypt_message()}')
